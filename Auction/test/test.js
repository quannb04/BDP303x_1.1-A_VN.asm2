...
contract('AuctionContract', function (accounts) {
  ...
  it("Should set winners", function() {
    ...
    ***********/
    return auctionInstance.register({from:accounts[1]})
      .then(function(result) {
      /**********
      ...
      ***********/
      assert.notEqual(result, '0x0000000000000000000000000000000000000000', "no winner 1");
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
                ***********/
      assert.notEqual(result, '0x0000000000000000000000000000000000000000', "no winner 2");
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result, '0x0000000000000000000000000000000000000000', "no winner 3");
    })
  });
});